...
must_haves:
  ...
  key_links:
    ...
    - from: "src/hooks/usePlaylistAnalysis.ts"
      ...
      pattern: "parseM3U8"
    - from: "src/hooks/usePlaylistAnalysis.ts"
      to: "src/analysis/resolver/resolveInput.ts"
      via: "resolveInput"
      pattern: "resolveInput"
    - from: "src/hooks/usePlaylistAnalysis.ts"
      to: "src/analysis/playlist/validatePlaylist.ts"
      via: "validatePlaylist"
      pattern: "validatePlaylist"
    - from: "src/hooks/usePlaylistAnalysis.ts"
      to: "src/analysis/playlist/classifyPlaylist.ts"
      via: "classifyPlaylist"
      pattern: "classifyPlaylist"
    - from: "src/hooks/usePlaylistAnalysis.ts"
      to: "src/analysis/ladder/extractLadder.ts"
      via: "extractLadder"
      pattern: "extractLadder"
